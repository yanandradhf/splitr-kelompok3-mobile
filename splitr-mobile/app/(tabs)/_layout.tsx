  ...
  return (
    <View style={{
      ...
      >
        ...
        <Ionicons name="home" size={24} color={isHome ? "#000000" : "#666666"} />
        <Text style={{
          fontSize: 12,
          marginTop: 4,
      ...
      <View style={{
        ...
        <TouchableOpacity style={{
          ...
          shadowOpacity: 0.15,
          shadowRadius: 3,
        }} activeOpacity={0.7} onPress={() => router.push('/create-bill')}>
      ...
      >
        ...
        <Ionicons name="stats-chart" size={24} color={isMonitoring ? "#000000" : "#666666"} />
        <Text style={{
          fontSize: 12,
          marginTop: 4,
